...
Uncomment the tests, they should pass by now. \o/
You have your safeguard.
...
All this part takes place in the `GrohlOMeter` class.
...
The `advice` method is now a giant switch.
